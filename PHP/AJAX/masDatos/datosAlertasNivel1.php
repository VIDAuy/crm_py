...
if (isset($_POST['CI'])) {
	$cedula = $_POST['CI'];
	$q = "UPDATE {$tabla} SET activo = '0' WHERE cedula = '$cedula'";
	...
	$q 	= "SELECT sector, nombre, telefono, cedula, observaciones FROM {$tabla} WHERE activo='1' AND envioSector = '$sector' AND cedula != ''";
	$r 	= mysqli_query($conexion, $q);
